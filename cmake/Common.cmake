...
if (PCCL_OPENTRACKING)
    add_definitions(-DPCCL_OPENTRACKING=1)
    set(OPENTRACKING_INC "/usr/local/include")
endif ()

# set(PCCL_OPENTRACKING $ENV{TARS_OPENTRACKING})
# if(PCCL_OPENTRACKING)
# set(OPENTRACKING_INC "/usr/local/include")
# add_definitions(-D_USE_OPENTRACKING=${PCCL_OPENTRACKING})
# endif()
...
IF (UNIX)
    set(CMAKE_INSTALL_PREFIX "/usr/local/pccl/cpp" CACHE STRING "set install path" FORCE)
ELSE()
...
message("PCCL_OPENTRACKING:         ${PCCL_OPENTRACKING}") 
